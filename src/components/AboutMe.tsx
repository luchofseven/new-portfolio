    ...
    <section id="about-me" className="section-container">
      ...
      <main className="about-me-container">
        <section className="about-me-container-section">
          ...
          <div>
            <picture>
              ...
              <img src="/vectors/computadora-3d.webp" alt="vector computadora 3d" />
            </picture>
            <p>
              ...
              <i>HTML, CSS, Sass, JavaScript, React</i>. También hago uso de <i>Next.Js, Tailwind, TypeScript, Node, NestJS, TypeORM</i>, entre otros.
            </p>
          </div>
          ...
          <div>
            <picture>
              ...
              <img src="/vectors/cohete-3d.webp" alt="vector cohete 3d" className="vector-rocket" />
            </picture>
            <p>
              Actualmente realizando aplicaciones <i>full stack</i>, con <i>React, TypeScript, NestJS y MYSQL o PostgreSQL</i>.
            </p>
          </div>
          ...
          <div>
            ...
            <p>Estoy dispuesto y me encantaría formar parte de una empresa o contribuir a un proyecto en conjunto.</p>
          </div>

          <p className="contact">
            Cualquiera sean tus dudas podés contactarme a través de mis medios de
            <span>
        ...
        <article className="about-me-container-article-first">
          ...
          <div>
            <picture>
              <source srcSet="/vectors/palanca-de-mando-3d.avif" type="image/avif" />
              <img src="/vectors/palanca-de-mando-3d.webp" alt="vector palanca de mando 3d" className="hobbies-image" />
            </picture>
            <aside className="hobbies-grid">
              <span>
                ...
                <picture>
                  ...
                  <img src="/hobbies/btf2042.webp" alt="icono de battlefield 2042" />
                </picture>
              </span>
              <span>
                <span className="shadow"></span>
              ...
              <span>
                ...
                <picture>
                  ...
                  <img src="/hobbies/cs2.webp" alt="icono de counter-strike 2" />
                </picture>
              </span>
              <span>
                <span className="shadow"></span>
                <picture>
                  ...
                  <img src="/hobbies/lol.webp" alt="icono de league of legends" />
                </picture>
              </span>
            </aside>
          </div>
